...
export function Footer({ footer = DEFAULT_FOOTER, footerLink = DEFAULT_FOOTER_LINK }: FooterProps) {
  return (
    <footer className="bg-blue-950 dark:bg-blue-900 text-white/50 py-1 px-3 z-50 text-sm text-center flex justify-between">
      <p>
      ...
      <p>
        2025{' '}
        <a
          href="https://github.com/JimmyKmi/vortex"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:underline"
        >
          © Designed By JimmyKmi
        </a>
      </p>
    </footer>
  )
