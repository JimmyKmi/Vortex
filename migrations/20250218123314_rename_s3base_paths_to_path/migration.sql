/*
  ...
  - You are about to drop the column `s3BasePaths` on the `TransferSession` table. All the data in the column will be lost.
...
INSERT INTO "new_TransferSession" ("createdAt", "fingerprint", "id", "ipAddress", "lastActivityAt", "linkedTransferCodeId", "status", "transferCodeId", "updatedAt", "userAgent") SELECT "createdAt", "fingerprint", "id", "ipAddress", "lastActivityAt", "linkedTransferCodeId", "status", "transferCodeId", "updatedAt", "userAgent" FROM "TransferSession";
