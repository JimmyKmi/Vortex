/*
  ...
  - You are about to drop the column `lastActivityAt` on the `TransferSession` table. All the data in the column will be lost.
...
INSERT INTO "new_TransferSession" ("createdAt", "fingerprint", "id", "ipAddress", "linkedTransferCodeId", "s3BasePath", "status", "transferCodeId", "updatedAt", "userAgent") SELECT "createdAt", "fingerprint", "id", "ipAddress", "linkedTransferCodeId", "s3BasePath", "status", "transferCodeId", "updatedAt", "userAgent" FROM "TransferSession";
